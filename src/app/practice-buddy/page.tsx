...
export default function PracticeBuddyPage() {
  ...
  const startInstantMatch = () => {
    setStatus('waiting');
    
    // Simulate finding a match
    setTimeout(() => {
      const mockSession: BuddySession = {
        id: Math.random().toString(36),
        partnerId: 'buddy123',
        partnerName: 'Alex Chen',
        partnerIndustry: 'Technology',
        partnerLevel: 'Mid Level',
        questions: [
  ...
  const joinFriendSession = () => {
    ...
    const mockSession: BuddySession = {
      ...
      partnerIndustry: 'Marketing',
      partnerLevel: 'Senior Level',
      sessionCode: friendCode,
      questions: [
        'Tell me about yourself',
        'Why are you interested in this role?',
        'Describe a challenging project you worked on',
