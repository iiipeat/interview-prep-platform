...
export default function HistoryPage() {
  ...
  const loadSessionHistory = async () => {
    try {
      ...
      // If we have some data but not much, add a few mock sessions for better UX
      if (transformedSessions.length < 3) {
        // Add recent mock data to show the feature works
        const mockRecent: Session[] = [
          {
            id: 'mock-1',
